            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-lg-3">
                        <button style="background-color: rgb(138, 30, 30); border-color: maroon" class="btn btn-primary btn-login" data-bs-toggle="modal" data-bs-target="#loginModal">Login</button>bs-target="#loginModal">Login</button>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="ms-auto">
                        <span class="badge bg-warning text-dark" id="timerBadge">
                            <i class="fas fa-clock me-1"></i><span id="countdown">05:00</span>
                        </span>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i> If you don't see the email, please check your spam folder.
                    </div>
